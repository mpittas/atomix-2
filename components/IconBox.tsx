  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 rounded-2xl overflow-hidden">
        ...
        {staticShine === 2 && (
          <>
            <div className="absolute -bottom-30 -top-30 right-5 w-22 bg-white/12 rotate-20 blur-lg" />
            <div className="absolute -bottom-30 -top-30 right-40 w-12 bg-white/12 rotate-20 blur-lg" />
          </>
        )}
        {staticShine === 3 && (
